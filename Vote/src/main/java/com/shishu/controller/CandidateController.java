...
import com.shishu.service.CandidateService;
...
public class CandidateController {
	...
	public ResponseEntity<List<Candidate>> getAllCandidates(){
		List<Candidate> candiateList = candidateService.getAllCandidate();
		return new ResponseEntity<List<Candidate>>(candiateList, HttpStatus.OK);
	}
